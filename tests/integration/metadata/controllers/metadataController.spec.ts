...
import { convertObjectToResponse, createFakeMetadataRecord } from '../../../helpers/helpers';
  ...
  describe('POST /metadata', function () {
    ...
    describe('Sad Path 😥', function () {
      ...
      it('should return 500 status code if a db exception happens', async function () {
        ...
        const response = await requestSender.createRecord(mockedApp, createFakeMetadataRecord());
