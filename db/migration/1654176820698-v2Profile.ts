...
export class v2Profile1654176820698 implements MigrationInterface {
  name = 'v2Profile1654176820698';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "records" ALTER COLUMN "product_name" DROP NOT NULL`);
    await queryRunner.query(`ALTER TABLE "records" ALTER COLUMN "product_type" DROP NOT NULL`);
    ...
    await queryRunner.query(`ALTER TABLE "records" ALTER COLUMN "region" DROP NOT NULL`);
    await queryRunner.query(`ALTER TABLE "records" ALTER COLUMN "production_system" DROP NOT NULL`);
    await queryRunner.query(`ALTER TABLE "records" ALTER COLUMN "production_system_version" DROP NOT NULL`);
    await queryRunner.query(`ALTER TABLE "records" ALTER COLUMN "producer_name" DROP NOT NULL`);
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "records" ALTER COLUMN "producer_name" SET NOT NULL`);
    await queryRunner.query(`ALTER TABLE "records" ALTER COLUMN "production_system_version" SET NOT NULL`);
    await queryRunner.query(`ALTER TABLE "records" ALTER COLUMN "production_system" SET NOT NULL`);
    await queryRunner.query(`ALTER TABLE "records" ALTER COLUMN "region" SET NOT NULL`);
    ...
    await queryRunner.query(`ALTER TABLE "records" ALTER COLUMN "product_type" SET NOT NULL`);
    await queryRunner.query(`ALTER TABLE "records" ALTER COLUMN "product_name" SET NOT NULL`);
