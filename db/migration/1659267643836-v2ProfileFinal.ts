...
export class v2ProfileFinal1659267643836 implements MigrationInterface {
  name = 'v2ProfileFinal1659267643836';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "records" ALTER COLUMN "insert_date" SET DEFAULT CURRENT_TIMESTAMP`);
