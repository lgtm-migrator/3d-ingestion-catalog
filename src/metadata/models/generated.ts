...
export class Metadata {
    ...
    @Column({name: 'product_version',type: 'real',nullable: false})
    ...
    @Column({name: 'production_system',type: 'text',nullable: true})
    public productionSystem?: string;
    @Column({name: 'production_system_version',type: 'text',nullable: true})
    ...
    @Column({name: 'mdsource',type: 'text',nullable: true})
    public mdSource?: string;
    @Column({name: 'xml',type: 'text',nullable: true})
    public xml?: string;
    @Column({name: 'anytext',type: 'text',nullable: true})
